            ...
            <main class="col-9 home-main-snippet">
                ...
                <div class="m-0 p-0 w-100 h-100">
                        ...
                        <div class="d-flex flex-row">
                            ...
                            <!--Boton comentarios-->
                                <button onclick="" class="simple-button p-0 px-2 d-flex justify-content-center align-items-center post-comment-button">
                                        ...
                                        <router-link :to="{ name: 'post.comentario', params: { id: post.id } }"><span class="mx-2 post-user-data">{{post.Usuario}}</span></router-link>
                    ...
                    <div class="m-0 p-0 w-100 h-100" v-for="(comment) in post.comments">
                        ...
                        <div class="box-40 mx-0" v-if="comment.ID_User==user.id" @click="deleteComment(comment.id)">
