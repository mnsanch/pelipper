            ...
            <div class="row p-0 mx-0 my-5">
                <main class="col-9 home-main-snippet">
                    ...
                    <form @submit.prevent="submitForm">
                        <div class="mt-3 mb-3">
                            <textarea v-model="comentario.Comment" id="post-Comment" type="text" class="form-control createpost-input" placeholder="Comenta algo, ¿no?" style="height:100px !important"></textarea> 
                        ...
                        <div class="comment my-3">
                            <div>
                                <div v-if="comment.ID_User==user.id" @click="deleteComment(comment.id)">
                                    <div class="d-flex justify-content-center align-items-center delete-comment-button">x</div>
                                </div>
