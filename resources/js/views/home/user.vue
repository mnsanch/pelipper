...
<script setup>
    ...
    const {posts, getPostsuser, getreversePosts, getPostsbestrated, getPostslowestrated, getPostsmostnegativevotes, getPostsmostvoted, sumarVoto, restarVoto, deletePosthome} = usePosts()
