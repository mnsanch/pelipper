                    ...
                    <div class="post-container">
                        ...
                        <div class="d-flex justify-content-between post-button-container">
                            ...
                            <div class="d-flex d-flex flex-row align-items-end">
                                ...
                                <!--Boton delete-->
                                <div class="box-40 mx-0" v-if="post.ID_User==user.id" @click="deletePosthated(post.id)">
...
<script setup>
    ...
    const {posts, avatrlink, getPosts, getreversePosts, getPostsbestrated, getPostslowestrated, getPostsmostnegativevotes, getPostsmostvoted, sumarVotohated, restarVotohated, deletePosthated, quitarupvotehated, quitardownvotehated} = usePosts()
