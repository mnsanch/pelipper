    ...
    <aside class="aside-main-left block-disapear">
        <div class="block-disapear aside-container-left">
            ...
            <ul class="block-disapear aside-ul-container-left">
                ...
                <router-link :to="{ name: 'homepopular' }" class="d-flex align-items-center aside-menu-nav-element pointer-custom">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="currentColor" class="position-absolute">
                        <defs>
                            ...
                            <stop offset="0%" class="offset0-stop-color"></stop>
                            <stop offset="100%" class="offset100-stop-color"></stop>
                            </linearGradient>
                        </defs>
                        <path d="M10 0a10 10 0 1 0 10 10A10.01 10.01 0 0 0 10 0Zm0 18.75a8.7 8.7 0 0 1-5.721-2.145l8.471-8.471v4.148H14V6.638A.647.647 0 0 0 13.362 6H7.718v1.25h4.148L3.4 15.721A8.739 8.739 0 1 1 10 18.75Z" fill="url(#gradient)"></path>
                    </svg>
                ...
                <div class="d-flex align-items-center aside-menu-nav-element pointer-custom">
                    <svg xmlns:xlink="http://www.w3.org/1999/xlink"  rpl="" fill="currentColor" height="20" viewBox="0 0 20 20" width="20" xmlns="http://www.w3.org/2000/svg" class="position-absolute">
                        ...
                        <div class="d-flex justify-content-between post-button-container">
                            <div class="d-flex flex-row">
                                ...
                                <div v-if="post.votes.length==0" class="d-flex align-items-center post-vote-button">
                                    <button onclick="" class="simple-button p-0 d-flex justify-content-center align-items-center post-upvote-button" @click="sumarVotopopular(post)">
                                        <span>
                                    ...
                                    <button onclick="" class="simple-button p-0 d-flex justify-content-center align-items-center post-downvote-button" @click="restarVotopopular(post)">
                                        <span>
                                            <svg rpl="" fill="currentColor" height="16" viewBox="0 0 20 20" width="16" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <p v-for="vote in post.votes">
                                    <p v-if="vote.vote==1">
                                        ...
                                        <button onclick="" class="simple-button p-0 d-flex justify-content-center align-items-center post-upvote-button" @click="quitarupvotepopular(post)">
                                            <span>
                                    ...
                                    <p v-if="vote.vote==0">
                                        ...
                                        <span class="d-flex align-items-center justify-content-center post-quantity-indicator">{{ post.Totalvotes }}</span>
                                        <button onclick="" class="simple-button p-0 d-flex justify-content-center align-items-center post-downvote-button" @click="quitardownvotepopular(post)">
                                            <span>
                            ...
                            <div class="d-flex d-flex flex-row align-items-end">
                                ...
                                <!--Boton delete-->
                                <div class="box-40 mx-0" v-if="post.ID_User==user.id" @click="deletePostpopular(post.id)">
...
<script setup>
    ...
    const {posts, avatrlink, getPosts, getreversePosts, getPostsbestrated, getPostslowestrated, getPostsmostnegativevotes, getPostsmostvoted, sumarVotopopular, restarVotopopular, deletePostpopular, quitarupvotepopular, quitardownvotepopular} = usePosts()
