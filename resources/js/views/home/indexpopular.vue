...
<script setup>
    ...
    const {posts, avatrlink, getPosts, getreversePosts, getPostsbestrated, getPostslowestrated, getPostsmostnegativevotes, getPostsmostvoted, sumarVotopopular, restarVotopopular, deletePosthome, quitarupvotepopular, quitardownvotepopular} = usePosts()
