        ...
        <div class="block-disapear aside-container-left" style= "height: 80dvh; overflow-y: scroll;">
            ...
            <ul class="block-disapear aside-ul-container-left">
                <div class="d-flex align-items-center aside-menu-nav-element">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="black" class="position-absolute">
                ...
                <div class="d-flex align-items-center aside-menu-nav-element">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none" class="position-absolute">
                ...
                <div class="m-0 p-0 w-100 h-100" v-for="(post, index) in posts.data" :key="post.id">
                    <div class="post-container">
                        ...
                        <div class="d-flex flex-row">
                            ...
                            <!--Boton comentarios-->
                                <button onclick="" class="simple-button p-0 px-2 d-flex justify-content-center align-items-center post-comment-button">
                                        ...
                                        <span class="p-0 d-flex justify-content-center align-items-center post-quantity-indicator">240</span>
                                </button>
                        </div>
                        <!-- Botones edit + delete -->
...
<script setup>
    ...
    const {posts, avatrlink, getPosts, getreversePosts, getPostsbestrated, getPostslowestrated, getPostsmostnegativevotes, getPostsmostvoted, sumarVoto, restarVoto, deletePosthome} = usePosts()
